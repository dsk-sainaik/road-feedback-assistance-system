                     ...
                     <div class="limit-box">
                        <nav class="main-menu">
                           <ul class="menu-area-main">
                              ...
                              <li>
                                 <a href="Authority.jsp">Trusted Authority</a>
                              </li>
                              <li>
                                 <a href="RSU.jsp">RSU</a>
                              </li>
                              <li class="active">
            ...
            <div class="row">
              ...
              <table>
                  <tr><th>Name</th><td><input type="text" name="name" required=""></tD></tr>
                   ...
                   <tr><th>Vehicle No</th><td><input type="text" name="vno" required=""></tD></tr>
                   ...
                   <tr><th>Password</th><td><input type="password" name="pass" required=""></tD></tr>
                    <tr><th></th><td><input type="submit" value="Register">
                            Already Have An Account ?<a href="Vehicle.jsp">Login</a></tD></tr>
              </table>
          </form>
